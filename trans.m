...
%-------------------------------------------------------------------------------------------------------------------
% Function that takes as input original coordinates and return the rotated and reduced coordinates (Marcotte, 1997)
%-------------------------------------------------------------------------------------------------------------------
%
% INPUT
%      model        : variogram model.
%      cx           : coefficient matrix of the coregionalization model.
%
% OUTPUT
%      cx           : fitted covariance model.
%      rot          : rotated and reduced coordinates.
%------------------------------------------------------------------------------------------------------------------
...
% check for 1D or isotropic model
if p-1>d
    ...
    % rotation matrix in 3D is computed around z, y and x in that order
